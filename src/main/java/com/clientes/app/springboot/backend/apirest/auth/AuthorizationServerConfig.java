...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public JwtAccessTokenConverter accessTokenConverter() {
		JwtAccessTokenConverter jwtAccesToken = new JwtAccessTokenConverter();
		jwtAccesToken.setSigningKey(JwtConfig.RSA_PRIVADO);
		jwtAccesToken.setVerifierKey(JwtConfig.RSA_PUBLICO);
